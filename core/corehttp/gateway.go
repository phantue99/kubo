...
func GatewayOption(paths ...string) ServeOption {
	return func(n *core.IpfsNode, _ net.Listener, mux *http.ServeMux) (*http.ServeMux, error) {
		...
		repoConfig, err := n.Repo.Config()
		if err != nil {
			return nil, err
		}

		gHandler := gateway.NewHandler(config, backend, repoConfig.ConfigPinningService.DedicatedGateway, repoConfig.ConfigPinningService.AmqpConnect)
...
func Libp2pGatewayOption() ServeOption {
	return func(n *core.IpfsNode, _ net.Listener, mux *http.ServeMux) (*http.ServeMux, error) {
		...
		gHandler := gateway.NewHandler(gwConfig, &offlineGatewayErrWrapper{gwimpl: backend}, repoConfig.ConfigPinningService.DedicatedGateway, repoConfig.ConfigPinningService.AmqpConnect)
